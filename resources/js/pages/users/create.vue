        ...
        <div class="max-w-xl mx-auto p-6 rounded-xl shadow">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="form.password" type="password" class="w-full border rounded px-2 py-1" required />
                </div>
                <div>
                    <label class="block mb-1">Confirmar contraseña</label>
                    <input v-model="form.password_confirmation" type="password" class="w-full border rounded px-2 py-1" required />
                </div>
                <div>
                ...
                <div class="flex gap-2">
                    <Button type="submit" class="bg-indigo-500 text-white hover:bg-indigo-700">Crear</Button>
